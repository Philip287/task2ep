...
public abstract class Tariff {
    ...
    public Tariff(String newId, PrintingCountry newCountry, String newTitle, int newSize, boolean coloured, boolean monthly, LocalDate date) {
        id = newId;
        country = newCountry;
        title = newTitle;
        size = newSize;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AbstractPaper)) {
            return false;
        }
        AbstractPaper second = (AbstractPaper) o;
        if (country != second.country) {
            return false;
        }
        if (id != second.id) {
            return false;
        }
        if (!title.equals(second.title)) {
            return false;
        }
        if (second.size != size) {
            return false;
        }
        if (isMonthly != second.isMonthly) {
            return false;
        }
        if (isColoured != second.isColoured) {
            return false;
        }
        if (!printingDate.equals(second.printingDate)) {
            return false;
        }
        return true;
    }
